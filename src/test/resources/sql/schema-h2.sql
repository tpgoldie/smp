...
CREATE TABLE IF NOT EXISTS SMP.T_COURSES(
    id INT PRIMARY KEY,
...
CREATE SEQUENCE IF NOT EXISTS SMP.S_COURSES_SEQ START WITH 100 INCREMENT BY 1;

ALTER TABLE SMP.T_COURSES ADD CONSTRAINT IF NOT EXISTS SMP.COURSES_DEPARTMENT_FK FOREIGN KEY(dept_id) REFERENCES SMP.T_DEPARTMENTS(id);
